...
public class ProfessionalProfessionJpaEntity {
  @Id
  @UuidGenerator
  private UUID id;
  ...
  protected ProfessionalProfessionJpaEntity() {}

  public ProfessionalProfessionJpaEntity(UUID tenantId, UUID organizationTypeId, String name, int sortOrder) {
