...
public class AttendanceExportService {
  ...
  public AttendanceExportService(ShiftJpaRepository shiftRepository, ProfessionalJpaRepository professionalRepository) {
    this.shiftRepository = shiftRepository;
    this.professionalRepository = professionalRepository;
  }

  @Transactional(readOnly = true)
  public byte[] exportCsv(OffsetDateTime from, OffsetDateTime to, String scheduleId, String professionalId) {
    ...
    csv.append("shiftId,scheduleId,professionalId,professionalName,startTime,endTime,checkInAt,checkOutAt,status,scheduledMinutes,workedMinutes,deltaMinutes,valueCents,currency\n");
